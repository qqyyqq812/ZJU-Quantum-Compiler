...
def _build_ibm_tokyo_coupling() -> CouplingMap:
    """IBM Tokyo (QX20) 拓扑 — 20 qubits 真实超导连通性。
    
    基于 IBM 公开的 ibmq_poughkeepsie / ibmq_tokyo 芯片规格，
    20 个超导量子比特排布为 4x5 近似网格，但存在若干缺失连边。
    这是论文级 20Q benchmark 的工业标准对照拓扑。
    """
    # IBM Tokyo 20Q 连通图 (双向)
    edges = [
        (0, 1), (0, 5),
        (1, 2), (1, 6), (1, 7),
        (2, 3), (2, 6), (2, 7),
...
_TOPOLOGY_REGISTRY: dict[str, callable] = {
    ...
    'ibm_tokyo': _build_ibm_tokyo_coupling,
}
